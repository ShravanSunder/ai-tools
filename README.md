...
| [`shravan-dev-workflow`](plugins/shravan-dev-workflow/) | Codex-first spec design, lifecycle discussion, docs maintenance, implementation review, plan workflows, debugging, TUI presentation, and PM Linear work |
