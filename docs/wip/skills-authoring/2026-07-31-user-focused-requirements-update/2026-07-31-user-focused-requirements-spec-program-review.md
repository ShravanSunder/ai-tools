...
Add `reader-understanding` to the lane-schema lane enum. Keep all common packet and receipt fields in the existing shared schema; lane-specific comprehension checks, per-element verdicts, and deletion consequences stay in the lane reference.
