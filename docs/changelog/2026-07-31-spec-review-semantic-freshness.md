...
- Active callers and routing docs were cut over together: `spec-design`, `program-design`, `spec-program-review`, `spec-handoff`, `plan-creation-swarm`, `plan-improve-repo`, `orchestrator-goal`, `research-swarm`, `discuss-clarify-mental-models`, plugin trigger evals, README, and AGENTS guidance.

## Validation

- Existing Vitest unit suite: 7 files and 33 tests passed.
- TypeScript typecheck: passed with zero errors.
- Codex `skill-creator` quick validation: all 9 changed skill folders passed through an isolated PyYAML environment.
