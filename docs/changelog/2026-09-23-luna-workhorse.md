...
- `manage-agents` uses Workhorse and Daily driver tiers. Guidance, Architectural span, and Interactive or background keep Workhorse on clear background work and out of interactive or event-keeping seats.
