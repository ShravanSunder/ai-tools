...
- Refresh/reinstall: Codex `shravan-dev-workflow@ai-tools` installed `2.8.0`; Claude plugin updated from `2.7.0` to `2.8.0` (restart to apply). Cursor cache still needs a local plugin refresh/restart.
