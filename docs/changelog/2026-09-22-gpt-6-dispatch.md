...
- Marketplace plugin: `shravan-dev-workflow` `2.45.0`.
...
- Operator: Luna medium. Worker Sol is low. Sidekick Sol and Opus low are complete direction; medium is partial direction. Tasks start on Luna high or xhigh. Review has categories again and no signal column. Sol medium is Balanced. Sol high, Astra, Opus, Fable, and Grok high are Frontier. Advisor Opus is high.
