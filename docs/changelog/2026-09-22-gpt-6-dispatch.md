...
- Marketplace plugin: `shravan-dev-workflow` `2.40.0`.
...
- Operator: Luna medium or high. Balanced Sol is low or medium. Worker and Sidekick tasks start on Luna high or xhigh. Review Sol is medium or high, and that table has no category column. Reviewer Grok is high.
