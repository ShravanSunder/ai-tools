...
- Marketplace plugin: `shravan-dev-workflow` `2.38.0`.
...
- Stop-review JEV fallback and pressure subjects default to `gpt-6-luna`. Pressure subject effort is high. The semantic judge stays `gpt-5.6-terra` at medium.
