...
- Marketplace plugin: `shravan-dev-workflow` `2.46.0`.
...
- Operator: Luna medium. Worker Sol is low. Sidekick Sol and Opus low are complete direction; medium is partial direction. Tasks start on Luna high or xhigh. Review has categories again and no signal column. Sol medium and Opus medium are Balanced. Sol high, Astra, Opus high, Fable, and Grok high are Frontier. Advisor Opus is high.
