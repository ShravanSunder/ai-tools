...
- Marketplace plugin: `shravan-dev-workflow` `2.43.0`.
...
- Operator: Luna medium. Worker Sol is low. Sidekick Sol and Opus low are complete direction; medium is partial direction. Tasks start on Luna high or xhigh. Review Sol is medium or high, and that table has no category column. Reviewer Grok is high.
