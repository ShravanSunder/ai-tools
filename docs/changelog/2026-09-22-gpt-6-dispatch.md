...
- Marketplace plugin: `shravan-dev-workflow` `2.42.0`.
...
- Operator: Luna medium. Worker Sol is low. Sidekick Sol is low or medium. Tasks start on Luna high or xhigh. Review Sol is medium or high, and that table has no category column. Reviewer Grok is high.
