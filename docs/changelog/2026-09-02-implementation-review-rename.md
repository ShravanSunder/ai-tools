...
Plugin: `shravan-dev-workflow` 2.10.0 (released with the coordinator DAG entry after merging master, which had reached 2.9.0)
...
- The renamed skill's description text, workflow behavior, and review contracts are unchanged in this release (sibling descriptions changed only by the name swap, e.g. `implementation-pr-wrapup`); the coordinator-DAG redesign lands in later runs of the accepted spec (`docs/wip/skills-authoring/2026-08-30-review-skills-rails-and-coordination.md`).
