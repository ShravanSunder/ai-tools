...
- Description text, workflow behavior, and review contracts are unchanged in this release; the coordinator-DAG redesign lands in later runs of the accepted spec (`docs/wip/skills-authoring/2026-08-30-review-skills-rails-and-coordination.md`).
