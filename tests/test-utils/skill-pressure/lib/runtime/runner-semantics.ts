...
export const RUNNER_SEMANTICS_MANIFEST = [
  ...
  { semanticClass: "contract_parser", path: "lib/contracts/write-path-policy.ts" },
  ...
  { semanticClass: "discovery_registry", path: "lib/authority/calibration-freshness.ts" },
  { semanticClass: "discovery_registry", path: "lib/authority/claimed-requirements.ts" },
  { semanticClass: "discovery_registry", path: "lib/authority/demotion-registry.ts" },
  { semanticClass: "discovery_registry", path: "lib/authority/demotion-transaction.ts" },
  { semanticClass: "discovery_registry", path: "lib/authority/promotion-transaction.ts" },
  { semanticClass: "discovery_registry", path: "lib/authority/promotion-registry.ts" },
  { semanticClass: "discovery_registry", path: "lib/authority/run-acceptance-transaction.ts" },
  { semanticClass: "discovery_registry", path: "lib/authority/runner-owned-receipt-path.ts" },
  { semanticClass: "discovery_registry", path: "lib/authority/runtime-authority-context.ts" },
