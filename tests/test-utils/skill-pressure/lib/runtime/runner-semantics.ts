...
export const RUNNER_SEMANTICS_MANIFEST = [
  ...
  { semanticClass: "contract_parser", path: "lib/contracts/contract-schema.ts" },
  ...
  { semanticClass: "review_runtime_profiles", path: "lib/review/acpx-blind-review-runner.ts" },
  { semanticClass: "review_runtime_profiles", path: "lib/review/acpx-review-result.ts" },
  { semanticClass: "review_runtime_profiles", path: "lib/review/review-packet.ts" },
  ...
  { semanticClass: "runner_package_commands", path: "scripts/run-live-pair.ts" },
  { semanticClass: "runner_package_commands", path: "scripts/run-live-scenario.ts" },
