# orchestrate-goal clarity gate pressure

scenario_id: orchestrate-goal-clarity-gate
skill_under_test: shravan-dev-workflow:orchestrate-goal
mode: fast
...
$shravan-dev-workflow:orchestrate-goal
...
- Agent does not run a mini interview inside `orchestrate-goal`.
