...
| `orchestrator-design` | `orchestrator-design-ready-plan-hands-execution-contact` | Main authors the plan, then the implementation Sidekick becomes the routine execution contact without inheriting governing authority. |
...
| `manage-agents` | `manage-agents-execution-contact-after-ready-plan` | Route routine post-plan execution conversation to the implementation Sidekick without transferring governing authorship or material decisions. |
