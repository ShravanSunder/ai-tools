...
```bash
CODEX_PRESSURE_MODEL=gpt-6-luna CODEX_PRESSURE_REASONING_EFFORT=xhigh \
...
| `manage-agents` | `manage-agents-sidekick-luna-xhigh` | Do not treat Luna as Worker-only; Exact-steps local Sidekick work may use OpenAI Luna high or xhigh Mini, and the cheaper pick is high. |
