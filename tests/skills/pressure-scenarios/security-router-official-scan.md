# security-router official scan pressure

scenario_id: security-router-official-scan
skill_under_test: shravan-dev-workflow:security-router
mode: fast
...
$shravan-dev-workflow:security-router
