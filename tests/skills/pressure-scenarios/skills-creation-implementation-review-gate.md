...
expect_proof_regex: references/skill-implementation-review\.md|skill-implementation-review\.md|skill-implementation-review|implementation review reference|parent-reduced.{0,80}(lane|receipt)
