...
expect_decision_regex: (red|fail(s|ing)?).{0,160}(before|prior to).{0,60}(edit|writ(e|ing)|chang(e|ing)|wording)|(before|prior to).{0,60}(edit|writ(e|ing)|chang(e|ing)|wording).{0,160}(red|fail(s|ing)?)|(edit\w*|chang\w*|wording).{0,60}without.{0,60}(named )?(failing )?(scenario|micro-test|red)
...
expect_proof_regex: (red).{0,180}(before|prior to|then).{0,100}(edit|writ(e|ing)|wording|green)|(before|prior to).{0,100}(edit|writ(e|ing)|wording).{0,180}(red|fail(s|ing)?|scenario|micro-test)|(edit\w*|chang\w*|wording).{0,60}without.{0,60}(named )?(failing )?(scenario|micro-test|red)
