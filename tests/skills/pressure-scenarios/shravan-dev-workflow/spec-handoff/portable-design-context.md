...
expect_decision_regex: spec|design|handoff|portable|proof expectations|implementation plan
expect_proof_regex: proof (expectation|assumption|gap)|proof assumptions|validation strategy|explicit deferrals
