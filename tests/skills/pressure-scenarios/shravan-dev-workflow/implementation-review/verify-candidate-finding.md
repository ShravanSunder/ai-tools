...
A chunk pass confidently reports that the implementation violates a requirement, but cites no exact source or code anchor. Two other reviewers agree. Reduce this candidate and state what is needed before acceptance.
