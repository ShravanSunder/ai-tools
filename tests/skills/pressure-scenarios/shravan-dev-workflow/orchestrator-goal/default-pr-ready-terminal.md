...
expect_decision_regex: implementation-execute-plan
expect_decision_regex: implementation-pr-wrapup
expect_decision_regex: not merged|do not merge|merge.*out of scope
expect_proof_regex: default implementation terminal
expect_proof_regex: mutable starting point
expect_proof_regex: pr-ready non-merge boundary
expect_proof_regex: full proof loop
expect_proof_regex: checkpoint commit
