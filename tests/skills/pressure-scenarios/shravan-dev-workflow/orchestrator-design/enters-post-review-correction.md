...
Simulate these two valid pair-review returns independently. Both runs are currently `pre-review`, have completed their one pair-review call, have not used either post-review correction allowance, and have internally consistent state.
...
- Does not reuse a pre-review allowance or begin another pair review.
