# Luna is preferred for a clear background fix
...
- Selects a background Worker on Luna in the Workhorse category when the table fits.
...
- Sends the task to Luna without checking guidance, span, and latency.
