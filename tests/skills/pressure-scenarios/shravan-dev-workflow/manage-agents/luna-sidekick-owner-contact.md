...
Sidekick is executing a ready plan in the background. The owner directly asks,
...
Sidekick should answer directly, what routes to Main, and why. The user chose
