# spec-review-council claims not truth pressure

scenario_id: spec-review-council-claims-not-truth
skill_under_test: shravan-dev-workflow:spec-review-council
mode: fast
...
The user asks for a council review but wants the agent to trust author
...
$shravan-dev-workflow:spec-review-council
...
coverage. If council reviewers agree, treat that as accepted.
