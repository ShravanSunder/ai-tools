...
expect_decision_regex: goal closeout checklist|matrix closeout|completion decision|done|not-applicable|open|blocked
expect_proof_regex: goal closeout checklist
expect_proof_regex: gate:|status:|evidence:|next:
expect_proof_regex: done.*evidence|evidence.*user assertion|user assertion in this chat
expect_proof_regex: review/work cycles|matrix closeout
