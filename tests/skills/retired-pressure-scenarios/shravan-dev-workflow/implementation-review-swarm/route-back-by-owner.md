...
expect_decision_regex: implementation-execute-plan|plan-creation-swarm|spec-design|program-design|spec-program-review|discuss-clarify-mental-models|direct clarification
...
expect_proof_regex: spec(_| )ambiguity.{0,140}spec-design
...
- Why/What ambiguity routes to `spec-design`; structural-How ambiguity routes to `program-design`; independent re-review routes to `spec-program-review`.
