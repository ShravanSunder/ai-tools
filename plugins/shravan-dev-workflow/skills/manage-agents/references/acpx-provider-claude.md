...
Use the pattern's reasoning floor and invoke every lifecycle command through
the wrapper so the custom model environment remains part of the relationship.
...
A friendly alias or exit code 0 does not prove Fable launched; verify capability
