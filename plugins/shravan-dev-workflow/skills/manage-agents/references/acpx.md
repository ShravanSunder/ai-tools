...
- Workers and Operators use native subagents; do not use ACPX to create a top-level Worker or Operator.
...
```bash
<provider-agent-command> sessions new --name "🐒 Sidekick · <purpose>"
