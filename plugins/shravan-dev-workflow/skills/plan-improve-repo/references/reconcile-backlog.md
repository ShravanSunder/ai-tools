...
These verdicts live only in a separate current-state reconciliation receipt. They never replace or mutate the canonical `ready | revision-requested | blocked` planning result.
