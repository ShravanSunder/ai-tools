...
- Planning or implementation sequencing: report the model and an explicit blocked handoff when the corresponding runtime phase is not shipped; do not invoke a retired workflow.
