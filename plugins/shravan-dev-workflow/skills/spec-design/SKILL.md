...
Completion: current independent review semantically covers the artifact, or the exact `non-substantial` basis, reused coverage, or blocking input is recorded.
