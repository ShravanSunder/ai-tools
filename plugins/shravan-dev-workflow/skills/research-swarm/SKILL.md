...
- caveats, competing hypotheses where evidence split, and unresolved gaps
   - recommended next workflow: usually `discuss-clarify-mental-models`, `spec-design`, `program-design`, `spec-program-review`, `plan-implementation`, `implement-plan`, `implementation-review`, or `docs-maintain`
