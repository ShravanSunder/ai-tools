...
IF writing the handoff artifact or copy-paste prompt, load `references/handoff-template.md` and return both filled artifacts with the unchanged canonical tuple and approval evidence or explicit absence.
...
- The handoff changes the plan tuple, treats `draft` as approval, or omits the separate approval-evidence record or explicit absence.
