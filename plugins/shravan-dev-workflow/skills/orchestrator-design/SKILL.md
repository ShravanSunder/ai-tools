...
- accepted bounded findings -> correct through the semantic owners; the retained independent design-review Sidekick checks corrected anchors and current affected evidence, then the orchestrator accepts the result.
