...
4. Monitor checks, comments, review threads, mergeability, and PR head SHA.
   ...
   operational agent, capability, packet, receipt, and escalation boundary.
...
- Load `manage-agents` before dispatching or resuming a subordinate PR monitor.
  This skill still owns PR gates; `manage-agents` owns the agent relationship,
  model/runtime choice, packet, receipt, and decision escalation.
