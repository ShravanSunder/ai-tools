...
| implementation-writing-tests | `plugins/shravan-dev-workflow/skills/implementation-writing-tests/` | Write, repair, audit, remove, and review tests as trustworthy implementation proof with seams, domain boundaries, invariants, illegal-state strategy, IO-boundary proof, oracles, proof layers, RED/GREEN, and weak-test antipattern checks |
