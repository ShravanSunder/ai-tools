...
| manage-agents | `plugins/shravan-dev-workflow/skills/manage-agents/` | Choose and manage advisors, sidekicks, subagents, and subagent swarms across model lineages, providers, native runtimes, ACPX sessions, automation, flows, and custom ACP adapter boundaries |
