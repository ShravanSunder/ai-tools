...
| manage-agents | `plugins/shravan-dev-workflow/skills/manage-agents/` | Choose and manage advisors, sidekicks, workers, operators, subagents, and their allowed swarms across Frontier/Balanced/Mini models, native runtimes, ACPX usage, and ACP adapter boundaries |
...
| track-show-me-your-work | `plugins/shravan-dev-workflow/skills/track-show-me-your-work/` | Keep a coordination root plus linked execution roots for consequential work history and continuation |
