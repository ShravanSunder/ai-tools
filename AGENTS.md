...
| spec-program-review | `plugins/shravan-dev-workflow/skills/spec-program-review/` | Independent specification, program-design, or pair review; records what was inspected and reruns only coverage affected by meaning changes |
...
| plan-creation-swarm | `plugins/shravan-dev-workflow/skills/plan-creation-swarm/` | Create written implementation plans from an admitted semantically current pair-ready or proven implementation-mechanics-only input, with proof gates and parallel work lanes, without editing code |
