...
| manage-agents | `plugins/shravan-dev-workflow/skills/manage-agents/` | Choose and manage advisors, sidekicks, delegates, operations, and their allowed swarms across Frontier/Balanced/Mini models, native subagents, ACPX sessions, automation, flows, and custom ACP adapter boundaries |
