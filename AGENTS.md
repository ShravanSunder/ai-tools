...
| manage-agents | `plugins/shravan-dev-workflow/skills/manage-agents/` | Choose and manage advisors, sidekicks, delegates, operator routes, and swarms across Frontier/Balanced/Mini models, native subagents, ACPX sessions, automation, flows, and custom ACP adapter boundaries |
