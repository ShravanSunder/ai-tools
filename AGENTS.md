...
| practices-research | `plugins/shravan-dev-workflow/skills/practices-research/` | Evidence-gathering workflow for local code/docs, prior art, current web/docs, Reader, memory, and session-log research with ordered source classes and tmp research ledgers |
